...
"""
    ...
    # Initialize Mistral AI client and set global embeddings cache file path
    initialise(topicGeneral, embeddings_cache_file)

    # Load sentiment cache
    sentimentCache_Load(sentiments_cache_file)
    ...
    for run in range(args.runs):
        ...
        most_important_clusters = clustering_topics(preprocessed_reviews)
